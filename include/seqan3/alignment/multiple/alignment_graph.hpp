...
template <std::ranges::RandomAccessRange sequence_container_type, typename weight_type>
requires std::ranges::RandomAccessRange<typename sequence_container_type::value_type>
      && sized_range_concept<typename sequence_container_type::value_type>
      && alphabet_concept<typename sequence_container_type::value_type::value_type>
